...
## This code generates the boxplots of confidence interval size, when sample size = 1434, but straitified by mean absolute prediction error (low, medium and high)
...
## Make combined plot
Figure5_female_CI_boxplot_by_MAPE_1434 <- ggarrange(res.APE1,res.APE2,res.APE3,nrow = 1,ncol=3)

ggsave("figures/Figure5_female_CI_boxplot_by_MAPE_1434.png",Figure5_female_CI_boxplot_by_MAPE_1434, dpi = 600, height = 3.5, width = 10.5)
