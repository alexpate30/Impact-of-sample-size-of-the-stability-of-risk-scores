...
### This program calculates Net Benefit in the validation cohort for each model derived on cohorts of sample size 2954 
...
for (k in 1:1000){
  ...
  ## Want to reduce development data to a random subset of 2954 patients, called random.dat
  ## Extract 2954 row numbers at random
  row.ids <- sample(1:nrow(data_devel),2954, replace = FALSE)
...
save.image("R_out_C4/NB_bootstrap_female_2954.RData")
print("saved")
