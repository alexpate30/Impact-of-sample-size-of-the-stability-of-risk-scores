...
ggsave("figures/Figure4_female_CI_boxplot_by_calibration_centered_50000.png",Figure4_female_CI_boxplot_by_calibration_centered_50000, dpi = 300, height = 3.5, width = 10.5)
