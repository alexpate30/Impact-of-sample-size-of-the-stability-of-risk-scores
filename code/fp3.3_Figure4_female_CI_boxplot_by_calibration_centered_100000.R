...
## This code generates the boxplots of confidence interval size, when sample size = 100000, but straitified by C statistic (low, medium and high)
...
## Make combined plot
Figure4_female_CI_boxplot_by_calibration_centered_100000 <- ggarrange(res.calib1,res.calib2,res.calib3,nrow = 1,ncol=3)
warnings()
Figure4_female_CI_boxplot_by_calibration_centered_100000
ggsave("figures/Figure4_female_CI_boxplot_by_calibration_centered_100000.png",Figure4_female_CI_boxplot_by_calibration_centered_100000, dpi = 300, height = 3.5, width = 10.5)
