...
### This program calculates Net Benefit in the validation cohort for each model derived on cohorts of sample size 10000 
...
save.image("R_out_C4/NB_bootstrap_female_10000.RData")
print("saved")
