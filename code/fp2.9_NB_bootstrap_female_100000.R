...
### This program calculates Net Benefit in the validation cohort for each model derived on cohorts of sample size 100000 
...
for (k in 1:1000){
  ...
  ## Want to reduce development data to a random subset of 100000 patients, called random.dat
  ## Extract 100000 row numbers at random
  row.ids <- sample(1:nrow(data_devel),100000, replace = FALSE)
...
save.image("R_out_C4/NB_bootstrap_female_100000.RData")
print("saved")
