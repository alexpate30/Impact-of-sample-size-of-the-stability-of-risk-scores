...
## Make combined plot
Figure3_female_CI_boxplot_by_C_statistic_2954 <- ggarrange(res.C.low,res.C.med,res.C.high,nrow = 1,ncol=3)

ggsave("figures/Figure3_female_CI_boxplot_by_C_statistic_2954.png",Figure3_female_CI_boxplot_by_C_statistic_2954, dpi = 600, height = 3.5, width = 10.5)
