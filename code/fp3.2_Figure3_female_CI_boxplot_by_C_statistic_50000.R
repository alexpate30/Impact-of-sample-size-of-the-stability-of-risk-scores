...
## This code generates the boxplots of confidence interval size, when sample size = 50,000, but straitified by C statistic (low, medium and high)
...
## Make combined plot
Figure3_female_CI_boxplot_by_C_statistic_50000 <- ggarrange(res.C.low,res.C.med,res.C.high,nrow = 1,ncol=3)
Figure3_female_CI_boxplot_by_C_statistic_50000
ggsave("figures/Figure3_female_CI_boxplot_by_C_statistic_50000.png",Figure3_female_CI_boxplot_by_C_statistic_50000, dpi = 300, height = 3.5, width = 10.5)
