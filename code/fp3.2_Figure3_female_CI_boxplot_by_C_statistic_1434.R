...
## This code generates the boxplots of confidence interval size, when sample size = 1,434, but straitified by C statistic (low, medium and high)
...
## Make combined plot
Figure3_female_CI_boxplot_by_C_statistic_1434 <- ggarrange(res.C.low,res.C.med,res.C.high,nrow = 1,ncol=3)

ggsave("figures/Figure3_female_CI_boxplot_by_C_statistic_1434.png",Figure3_female_CI_boxplot_by_C_statistic_1434, dpi = 600, height = 3.5, width = 10.5)
